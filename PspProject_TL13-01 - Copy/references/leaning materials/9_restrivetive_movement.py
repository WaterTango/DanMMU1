...
#load image
spaceship_image = pygame.image.load("Red_spaceship32.png")
...
while running:
    ...
    if keys[pygame.K_d] and spaceship_rect.right < WINDOW_WIDTH:
        spaceship_rect.x += VELOCITY
    if keys[pygame.K_w] and spaceship_rect.top > 0 :
        spaceship_rect.y -= VELOCITY
    if keys[pygame.K_s] and spaceship_rect.bottom < WINDOW_HEIGHT:
        spaceship_rect.y += VELOCITY
